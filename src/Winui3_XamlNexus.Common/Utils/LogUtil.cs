...
using Winui3_XamlNexus.Common.Utils.Archive;
using Winui3_XamlNexus.Common.Utils.Hardware;
...
namespace Winui3_XamlNexus.Common.Utils {
    public static class LogUtil {
        ...
        public static void ExportLogFiles(string savePath) {
            ...
            var logFolderCore = Consts.CommonPaths.LogDirCore;
            if (Directory.Exists(logFolder)) {
            ...
            var layoutFile = Consts.CommonPaths.WallpaperLayoutPath;
