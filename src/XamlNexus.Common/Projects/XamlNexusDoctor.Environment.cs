...
public static partial class XamlNexusDoctor {
    ...
    public static XamlNexusDoctorReport DiagnoseEnvironment(string directory) {
        ...
        checks.Add(Pass("XD1004", "Environment", string.Format(LanguageRegistry.GetText("DoctorArchitecture"),
        ...
        if (OperatingSystem.IsWindows()) {
            try {
                ...
                checks.Add(Warning("XD1005", "Environment", LanguageRegistry.GetText("DoctorSdkUnknown") + " " + exception.Message));
            }
        }
        checks.Add(Warning("XD1006", "Environment", LanguageRegistry.GetText("DoctorEnvironmentBoundary")));
    ...
    internal static XamlNexusDoctorCheck InspectWindowsSdk(string root) {
        ...
        return versions.Length > 0
            ? Pass("XD1005", "Environment", string.Format(LanguageRegistry.GetText("DoctorSdkFound"), versions[0], root))
            : Warning("XD1005", "Environment", LanguageRegistry.GetText("DoctorSdkUnknown"));
    }
}
