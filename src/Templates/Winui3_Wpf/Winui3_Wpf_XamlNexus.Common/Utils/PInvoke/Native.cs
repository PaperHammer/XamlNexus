...
namespace Winui3_Wpf_XamlNexus.Common.Utils.PInvoke {
#pragma warning disable CA1707, CA1401, CA1712
    public static class Native {
        ...
        public static extern nint GetAncestor(nint hwnd, GetAncestorFlags flags);
        ...
        public static extern void DwmSetWindowAttribute(nint hwnd,
        ...
        public static extern nint LoadImage(nint hinst, string lpszName, uint uType,
        ...
        public static extern void NtResumeProcess(nint processHandle);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        [DllImport("user32.dll", SetLastError = true, CharSet = CharSet.Auto)]
        public static extern bool PostMessage(HandleRef hWnd, uint Msg, nint wParam, nint lParam);

        [DllImport("User32.dll", EntryPoint = "PostMessageW", CallingConvention = CallingConvention.Winapi
        , CharSet = CharSet.Unicode)]
        public extern static nint PostMessageW(nint hWnd, int Msg, nint wParam, nint lParam);

        [DllImport("User32.dll", EntryPoint = "PostMessageW", CallingConvention = CallingConvention.Winapi, CharSet = CharSet.Unicode)]
        public extern static nint PostMessageW(nint hWnd, int Msg, nint wParam, nuint lParam);
        ...
        [DllImport("kernel32.dll")]
        public static extern bool SetProcessWorkingSetSize(nint hProcess, int
        ...
        public static nint SetWindowLong(nint hWnd, int nIndex, long dwNewLong) {
            if (nint.Size == 4) {
        ...
        public static extern nint SetWindowLongPtr32(nint hWnd, int nIndex, long dwNewLong);

        [DllImport("User32.dll", CharSet = CharSet.Auto, EntryPoint = "SetWindowLongPtr")]
        public static extern nint SetWindowLongPtr64(nint hWnd, int nIndex, long dwNewLong);
        ...
        [DllImport("user32.dll", SetLastError = true)]
        public static extern nint FindWindow(string lpWindowClass, string lpWindowName);

        [DllImport("user32.dll", SetLastError = true, CharSet = CharSet.Auto)]
        public static extern nint SendMessageTimeout(nint hWnd, uint Msg, nint wParam, nint lParam, SendMessageTimeoutFlags fuFlags, uint uTimeout, out nint lpdwResult);
        ...
        */
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool SetWindowPos(nint hwnd, int hWndInsertAfter, int x, int y, int cx, int cy, int wFlags);

        [DllImport("user32.dll")]
        public static extern nint GetDesktopWindow();

        [DllImport("Shell32.dll")]
        public static extern int SHChangeNotify(int eventId, int flags, nint item1, nint item2);
        ...
        [DllImport("User32.dll")]
        public static extern int SetForegroundWindow(nint point);
        ...
        [DllImport("coredll.dll", SetLastError = true)]
        public static extern int GetModuleFileName(nuint hModule, StringBuilder lpFilename, int nSize);

        [DllImport("user32.dll", SetLastError = true)]
        public static extern int GetWindowRect(nint hwnd, out RECT rc);
        ...
        [return: MarshalAs(UnmanagedType.I4)]
        public static extern int MapWindowPoints(nint hWndFrom, nint hWndTo, [In, Out] ref RECT rect, [MarshalAs(UnmanagedType.U4)] int cPoints);

        [DllImport("user32", ExactSpelling = true, SetLastError = true)]
        public static extern int MapWindowPoints(nint hWndFrom, nint hWndTo, [In, Out] ref System.Drawing.Point pt, [MarshalAs(UnmanagedType.U4)] int cPoints);
        ...
        public struct ParentProcessUtilities {
            ...
            [DllImport("ntdll.dll")]
            private static extern int NtQueryInformationProcess(nint processHandle, int processInformationClass, ref ParentProcessUtilities processInformation, int processInformationLength, out int returnLength);
        ...
        [DllImport("user32.dll", SetLastError = true)]
        public static extern nint GetWindow(nint hWnd, GetWindowType uCmd);
