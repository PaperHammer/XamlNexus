...
namespace Winui3_XamlNexus.AppSettingsPanel.ViewModels {
    public partial class GeneralSettingViewModel : ObservableObject, IDisposable {
        ...
        public string AppVersionText {
            get {
                ...
                if (Consts.ApplicationType.IsTestBuild)
                    ...
                    ver += $" {LanguageUtil.GetI18n(Consts.I18n.Settings_General_Version_MsStore)}";
                return ver;
            }
        }
        ...
        private void InitText() {
            ...
            _sysbdDefault = LanguageUtil.GetI18n(Consts.I18n.Settings_General_AppearanceAndAction__sysbdDefault);
            _sysbdMica = LanguageUtil.GetI18n(Consts.I18n.Settings_General_AppearanceAndAction__sysbdMica);
            _sysbdAcrylic = LanguageUtil.GetI18n(Consts.I18n.Settings_General_AppearanceAndAction__sysbdAcrylic);
        }
        ...
        private void ChangeAutoShartStatu(bool isAutoStart) {
            if (isAutoStart) {
                AutoStartStatu = LanguageUtil.GetI18n(Consts.I18n.Text_On);
            }
            else {
                AutoStartStatu = LanguageUtil.GetI18n(Consts.I18n.Text_Off);
            }
        }
