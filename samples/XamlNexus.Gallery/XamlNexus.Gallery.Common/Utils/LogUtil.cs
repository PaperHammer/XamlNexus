...
using XamlNexus.Gallery.Common.Utils.Archive;
using XamlNexus.Gallery.Common.Utils.Hardware;
...
namespace XamlNexus.Gallery.Common.Utils {
    public static class LogUtil {
        ...
        public static string GetHardwareInfo() {
            ...
            return $"\n" +
                $"XamlNexus.Gallery v{version} {arch} (OS {osArch}) {container} {CultureInfo.CurrentUICulture.Name}" +
