namespace XamlNexus.Gallery.Common {
    public static class Consts {
        ...
        public static class CommonPaths {
            ...
            /// 数据存储根目录
            /// </summary>
            public static string AppDataDir => Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "XamlNexus.Gallery");
        ...
        public static class ModuleName {
            public static string UIComponent => "XamlNexus.Gallery.UIComponent";
        }

        public static class CoreField {
            public static string AppName => "XamlNexus.Gallery";
            public static string UniqueAppUid => "XamlNexus.Gallery:SYSTEM";
            public static string UniqueAppUIUid => "XamlNexus.Gallery:UI:SYSTEM";
        }
