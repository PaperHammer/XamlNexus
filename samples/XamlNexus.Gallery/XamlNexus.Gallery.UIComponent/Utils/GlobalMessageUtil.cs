...
using XamlNexus.Gallery.Models.Mvvm;
using XamlNexus.Gallery.UIComponent.Templates;

namespace XamlNexus.Gallery.UIComponent.Utils {
    /// <summary>
    /// 全局消息服务
    /// </summary>
    public static class GlobalMessageUtil {
        ...
        public static void ShowCanceled(ArcWindow? arcWindow = null) {
            AddMsg(arcWindow, new GlobalMsgInfo(
                key: nameof(Consts.I18n.InfobarMsg_Cancel),
                isNeedLocalizer: true,
                msgOri18nKey: nameof(Consts.I18n.InfobarMsg_Cancel),
                extraMsg: null,
