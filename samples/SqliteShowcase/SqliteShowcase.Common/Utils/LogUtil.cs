...
using SqliteShowcase.Common.Utils.Archive;
using SqliteShowcase.Common.Utils.Hardware;

namespace SqliteShowcase.Common.Utils {
    public static class LogUtil {
        ...
        public static string GetHardwareInfo() {
            ...
            return $"\n" +
                $"SqliteShowcase v{version} {arch} (OS {osArch}) {container} {CultureInfo.CurrentUICulture.Name}" +
