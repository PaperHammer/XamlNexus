namespace SqliteShowcase.Common {
    public static class Consts {  
        ...
        public static class CommonPaths {
            ...
            /// 数据存储根目录
            /// </summary>
            public static string AppDataDir => Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "SqliteShowcase");
        ...
        public static class ModuleName {
            public static string UIComponent => "SqliteShowcase.UIComponent";
        }

        public static class CoreField {
            public static string AppName => "SqliteShowcase";            
            public static string UniqueAppUid => "SqliteShowcase:SYSTEM";
            public static string UniqueAppUIUid => "SqliteShowcase:UI:SYSTEM";
        }
